...
void main() {
   ...
   if (u_ratio > 1.0) { 
    ...
    point[0] = vec3(0.83, 0.75, 0.50);   // Max z-value at 0.5
    point[1] = vec3(0.60, 0.07, 0.40);
    point[2] = vec3(0.15, 0.85, 0.10);
    point[3] = vec3(0.76, 0.32, 0.00);   // Middle point at 0.0
    point[4] = vec3(0.45, 0.50, -0.10);
    point[5] = vec3(0.55, 0.81, -0.40);
    point[6] = vec3(0.38, 0.92, -0.50); // Min z-value at -0.5
    point[7] = vec3(0.12, 0.35, -0.35);
    point[8] = vec3(0.48, 0.67, 0.25);
    point[9] = u_mouse;
